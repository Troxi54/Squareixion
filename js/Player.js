...
function setNosaveValues()
{
    ...
    nosave.milestones = {
        master_milestones: [
            ...
            new Milestone(18, function(){ return Decimal.pow(5, player.master_level.minus(15)); }, 'giant_cube_damage', 'master_level', function() { return `<span class="size-75">Multiplies your ${fs.abbCurrency(this.boosts_what)} by 5 each master level starting at 16 and allows you to hold GS to damage them</span>` }, 9, ()=>nosave.milestones.master_milestones),
            ...
            new Milestone(2500, function(){ return 1; }, '-', 'master_level', function() { return `Unlocks a new giga square upgrade` }, 16, ()=>nosave.milestones.master_milestones),
        ...
        collapse_milestones: [
            new Milestone(1, function(){ return 1; }, '-', 'collapsed_times', function() { return `Permanently keep light upgrade 3, bulk master levels and unlocks new master milestones`}, 0, ()=>nosave.milestones.collapse_milestones, `Collapsed once`),
            ...
            new Milestone(()=>player.masters_on_collapse.lte(0), function(){ return 1; }, '-', 'masters_on_collapse', function() { return `Unlocks the autoclicker for giant squares, automatic nothing-resetting master levels, giga upgrades no longer take ${fs.abbCurrency('giga_squares')}, keep master milestone 4, 7 and unlocks a new star upgrade`}, 3, ()=>nosave.milestones.collapse_milestones, `Collapsed with master level 0`),
        ...
        rebuild_milestones: [
            ...
            new Milestone(140, function(){ return 1; }, '-', 'rebuild_rank', function() { return `<span class="size-75">Unlocks <span class="white-holes-stroke">The Unique Place</span>, moves rebuild reset here and bulk rebuild ranks</span>`}, 11, ()=>nosave.milestones.rebuild_milestones, `Rebuild rank ${abb_abs_int(140)}`),
    ...
    nosave.Autoclickers = {
        ...
        'prestige_upgrades_nocost' : new Auto(()=>true, function(){player.upgrades.prestige_upgrades.forEach(upgr=>upgr.takes_currency = !nosave.milestones.master_milestones[0].enough)}, ()=>getLoopInterval()),
        ...
        'light_upgrades_nocost' : new Auto(()=>true, function(){player.upgrades.light_upgrades.forEach(upgr=>upgr.takes_currency = !nosave.milestones.master_milestones[3].enough)}, ()=>getLoopInterval()),
        ...
        'ruby_upgrades_nocost' : new Auto(()=>true, function(){player.upgrades.ruby_upgrades.forEach(upgr=>upgr.takes_currency = !nosave.milestones.collapse_milestones[1].enough)}, ()=>getLoopInterval()),
        ...
        'giga_upgrades_nocost' : new Auto(()=>true, function(){player.upgrades.giga_upgrades.forEach(upgr=>upgr.takes_currency = !nosave.milestones.collapse_milestones[3].enough)}, ()=>getLoopInterval()),
        ...
        'star_upgrades_nocost' : new Auto(()=>true, function(){player.upgrades.collapse_upgrades.forEach(upgr=>upgr.takes_currency = !nosave.milestones.rebuild_milestones[0].enough)}, ()=>getLoopInterval()),
